...
const AccountPage = () => {
    ...
    const previewProps = {
        ...
        previewBgGradientTo: livePreviewState.bgGradientTo,
        previewBgGradientDirection: livePreviewState.bgGradientDirection,
        previewBgImage: livePreviewState.bgImage,
        previewBgImageOverlay: livePreviewState.bgImageOverlay,
        previewTextColor: livePreviewState.textColor,
