...
A collection of frontend builds — landing pages, small apps, and UI challenges. Each one is
deployed and linked below.

Everything here is practice work: the point was to ship a lot of small things and get fast at
layout, responsive behaviour, and state management.
...
Frontend Mentor–style challenges, built from design specs.
...
Most builds are plain HTML/CSS/JS — open `index.html` and you're done.

The ones with a `package.json` (`linktree`, `TodoApp`, `ReactNative/MovieApp`) need:
...
Built by [Prince Ji](https://github.com/princeji100) · [princeji.com](https://princeji.com)
